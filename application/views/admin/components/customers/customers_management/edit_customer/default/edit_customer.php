		...
		<header>
			<h1><?php echo lang('edit_customer'); ?></h1>
		</header>
		...
		<div>
			...
			<?= form_open( get_url( 'admin'.$this->uri->ruri_string() ), array( 'id' => 'customer-form', ) ); ?>
				...
				<fieldset class="fl">
					...
					<?php echo form_input(array('id'=>'title','name'=>'title','title'=>lang('tip_provider_title')),set_value('title', $customer->title),'autofocus'); ?>
					...
					<?php
						...
						endforeach;
					?>
					<?php echo form_dropdown('company_id', $options, set_value('company_id', $customer->company_id),'id="company-id"'); ?>
					<?php $options = array(); ?>
					...
					<?php
						...
						endforeach;
					?>
					<?php echo form_dropdown('contact_id', $options, set_value('contact_id', $customer->contact_id),'id="contact-id"'); ?>
					<?php $options = array(); ?>
					...
					<?php
						...
						endforeach;
					?>
					<?php echo form_dropdown('category_id', $options, set_value('category_id', $customer->category_id),'id="category-id"'); ?>
					<?php $options = array(); ?>
