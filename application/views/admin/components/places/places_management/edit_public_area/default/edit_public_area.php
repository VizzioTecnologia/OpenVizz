		...
		<div>
			...
			<?php echo form_open(get_url('admin'.$this->uri->ruri_string())); ?>
				...
				<fieldset class="fl">
					...
					<?php echo form_input(array('id'=>'title','name'=>'title'),set_value('title', $public_area->title),'autofocus'); ?>
					
					<?php echo form_error('postal_code', '<div class="msg-inline-error">', '</div>'); ?>
					<?php echo form_label(lang('postal_code')); ?>
					<?php echo form_input(array('id'=>'postal-code','name'=>'postal_code'),set_value('postal_code', $public_area->postal_code)); ?>
					
					<?php echo form_error('coordinates', '<div class="msg-inline-error">', '</div>'); ?>
					<?php echo form_label(lang('coordinates')); ?>
					<?php echo form_input(array('id'=>'coordinates','name'=>'coordinates'),set_value('coordinates', $public_area->coordinates)); ?>
					
					<?php echo form_error('map_url', '<div class="msg-inline-error">', '</div>'); ?>
					<?php echo form_label(lang('map_url')); ?>
					<?php echo form_input(array('id'=>'map-url','name'=>'map_url'),set_value('map_url', $public_area->map_url)); ?>
