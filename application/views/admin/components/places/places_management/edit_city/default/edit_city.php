		...
		<header>
			<h1><?php echo lang('edit_city'); ?> - <?php echo lang($state->title); ?> - <?php echo lang($country->title); ?></h1>
		</header>
		...
		<div>
			...
			<?php echo form_open(get_url('admin'.$this->uri->ruri_string())); ?>
				...
				<fieldset class="fl">
					...
					<?php echo form_input(array('id'=>'title','name'=>'title'),set_value('title', $city->title),'autofocus'); ?>
