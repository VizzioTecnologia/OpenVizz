		...
		<div>
			...
			<?php echo form_open(get_url('admin'.$this->uri->ruri_string())); ?>
				...
				<fieldset class="fl">
					...
					?>
					<?php echo form_dropdown('status', $options, set_value('status', $country->status),'id="status"'); ?>
					<?php $options = array(); ?>
					
					<?php echo form_error('title', '<div class="msg-inline-error">', '</div>'); ?>
					<?php echo form_label(lang('title')); ?>
					<?php echo form_input(array('id'=>'title','name'=>'title'),set_value('title', $country->title),'autofocus'); ?>
					
					<?php echo form_error('alias', '<div class="msg-inline-error">', '</div>'); ?>
					<?php echo form_label(lang('alias')); ?>
					<?php echo form_input(array('id'=>'alias','name'=>'alias'),set_value('alias', $country->alias)); ?>
