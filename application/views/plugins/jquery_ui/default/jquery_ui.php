...
<script type="text/javascript">
	...
	window.jqui_dp_on_select_function = function( date_text, dp, el ) {
		
		console.log( '[jQuery UI][Datepicker] jqui_dp_on_select_function callback function called' );
		
		if ( el.data( 'jqui-dp-target-var' ) ){
			
			window[ el.data( 'jqui-dp-target-var' ) ] = date_text;
			console.log( '[jQuery UI][Datepicker] ' + window[ el.data( 'jqui-dp-target-var' ) ] );
			
		}
		
		if ( el.data( 'jqui-dp-on-select-callback-function' ) ){
			
			window[ el.data( 'jqui-dp-on-select-callback-function' ) ]( date_text, dp, el );
			console.log( '[jQuery UI][Datepicker] calling on select callback function ' + el.data( 'jqui-dp-on-select-callback-function' ) );
	...
	$( document ).on( 'click', '.date', function( event ) {
		...
		switch ( event.which ) {
			...
			case 1:
				...
				console.log( '[jQuery UI][Datepicker] Left Mouse click' );
			...
			case 2:
				...
				console.log( '[jQuery UI][Datepicker] Middle Mouse click' );
			...
			case 3:
				...
				console.log( '[jQuery UI][Datepicker] Right Mouse click' );
			...
			default:
				...
				console.log( '[jQuery UI][Datepicker] Other Mouse button click' );
