...
// 	echo '<pre>' . print_r( $submit_form, TRUE ) . '</pre>';
	...
	if ( check_var( $submit_form[ 'ud_image_prop' ] ) ) {
		...
		foreach ( $submit_form[ 'ud_image_prop' ] as $_alias => & $_value ) {
	...
	if ( check_var( $submit_form[ 'ud_title_prop' ] ) ) {
		...
		foreach ( $submit_form[ 'ud_title_prop' ] as $_alias => & $_value ) {
	...
	if ( check_var( $submit_form[ 'ud_content_prop' ] ) ) {
		...
		foreach ( $submit_form[ 'ud_content_prop' ] as $_alias => & $_value ) {
	...
	if ( check_var( $submit_form[ 'ud_other_info_prop' ] ) ) {
		...
		foreach ( $submit_form[ 'ud_other_info_prop' ] as $_alias => & $_value ) {
	...
	if ( check_var( $submit_form[ 'ud_status_prop' ] ) ) {
		...
		foreach ( $submit_form[ 'ud_status_prop' ] as $_alias => & $_value ) {
	...
	if ( check_var( $submit_form[ 'ud_event_datetime_prop' ] ) ) {
		...
		foreach ( $submit_form[ 'ud_event_datetime_prop' ] as $_alias => & $_value ) {
