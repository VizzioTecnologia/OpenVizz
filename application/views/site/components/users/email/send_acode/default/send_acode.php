...
<section class="c-users resend-acode-form-wrapper form-wrapper <?= @$params['page_class']; ?>">
	
	<div class="form-wrapper-sub">
		
		<?= form_open( get_url( $url ), array( 'id' => 'resend-acode-form', ) ); ?>
			
			<header class="form-header">
				
				<h1>
					
					<?= lang( 'c_users_resend_acode_page_title' ); ?>
				...
				<?php
					...
					echo vui_el_button(
						...
						array(
							...
							'text' => lang( 'c_users_submit_resend_acode_field_label' ),
							'button_type' => 'button',
							'name' => 'submit_resend_acode',
							'id' => 'submit-resend-acode',
							'class' => 'submit-resend-acode',
