...
?>
<label class="vui-interactive-el-wrapper vui-checkbox-wrapper<?= $wrapper_class ? ' ' . $wrapper_class : ''; ?> <?= $_wrapper_class; ?>" <?= $_title ? $_title : ''; ?>><?php
	
	$input_params = array(
		
		'name' => $name,
		'checked' => $checked ? 'checked' : '',
		'class' => 'vui-checkbox' . ( $class ? ' ' . $class : '' ),
		'id' => $id,
		'form' => $form,
		'value' => $value,
