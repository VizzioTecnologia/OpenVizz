...
class Courses_search_plugin extends Plugins_mdl{
	...
	public function run( &$data, $params = NULL ){
		...
		if ( is_object( $this->search ) ) {
			...
			log_message( 'debug', '[Plugins] Courses search plugin initialized' );
			...
			$plugin_params =									isset( $plugin_params[ 'courses_search' ] ) ? $plugin_params[ 'courses_search' ] : array();
