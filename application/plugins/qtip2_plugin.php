...
class Qtip2_plugin extends Plugins_mdl{
	...
	public function run( &$data, $params = NULL ){
		...
		if ( ! $this->ua->is_mobile() AND parent::_performed( 'jquery' ) ){
			...
			$this->voutput->append_head_script_declaration( 'qtip2', $this->load->view( 'plugins/qtip2/default/qtip2', NULL, TRUE ), NULL, NULL );
