...
<section class="submit-form users-submits <?= @$params['page_class']; ?> centros">
		...
		<div id="users-submits-search-results-wrapper" class="users-submits-wrapper results">
			...
			<?php if ( check_var( $users_submits ) ) { ?>
				...
				?>
					...
					<div class="user-submit-wrapper modal <?= $_us_wrapper_class ?>" data-fancybox-title="<?= $modal_title; ?>" data-fancybox-type="inline" data-fancybox-group="users-submits" >
