...
$_path = SITE_THEMES_PATH . site_theme() . DS . VIEWS_DIR_NAME . DS . COMPONENTS_DIR_NAME . DS . 'submit_forms' . DS . 'index' . DS . 'users_submits' . DS . 'centros_2' . DS;
...
<section id="submit-form-users-submits-<?= $unique_hash; ?>" class="submit-form users-submits <?= @$params['page_class']; ?> centros">
	...
	$( document ).on( 'ready', function( e ){
		...
		$( "#submit-form-users-submits-<?= $unique_hash; ?> .modal" ).fancybox({
			...
			beforeShow: function(){
				...
				fbContent = $( this ).html();
				$(".fancybox-overlay").addClass("user-submit-detail users-submits-layout-testimonials centros");
