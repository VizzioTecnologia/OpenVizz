...
if ( ! defined( 'VUI_SEC_FONT_COLOR' ) ) define( 'VUI_SEC_FONT_COLOR', $vui->colors->vui_base_title_fg->rgba_s() );
...
if ( ! defined( 'VUI_DEFAULT_LINE_HEIGHT' ) ) define( 'VUI_DEFAULT_LINE_HEIGHT', ( 1.7 * VUI_SCALE ) . 'em' );
...
if ( ! defined( 'VUI_DEFAULT_BORDER_RADIUS' ) ) define( 'VUI_DEFAULT_BORDER_RADIUS', '3px' );

if ( ! defined( 'VUI_DEFAULT_TRANSITION_DURATION' ) ) define( 'VUI_DEFAULT_TRANSITION_DURATION', '0' );

if ( ! defined( 'VUI_DEFAULT_TRANSITION' ) ) define( 'VUI_DEFAULT_TRANSITION', 'all ' . VUI_DEFAULT_TRANSITION_DURATION . ' ease-in-out' );

if ( ! defined( 'VUI_DEFAULT_THUMB_SIZE' ) ) define( 'VUI_DEFAULT_THUMB_SIZE', '100px' );
