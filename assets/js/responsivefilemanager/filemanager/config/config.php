...
if ( ! defined( 'RELATIVE_BASE_URL' ) ) define( 'RELATIVE_BASE_URL', rtrim( str_replace( 'assets/js/responsivefilemanager/filemanager/dialog.php', '', $_SERVER[ 'PHP_SELF' ] ), '/' ) );
...
$config = array(
	...
	'thumb_width' => isset( $ov_config[ 'thumbnails_width' ] ) ? ( int ) $ov_config[ 'thumbnails_width' ] : 200,
	'thumb_height' => isset( $ov_config[ 'thumbnails_height' ] ) ? ( int ) $ov_config[ 'thumbnails_height' ] : 200,
	/*
	|--------------------------------------------------------------------------
	...
	|
	*/
	'base_url' => HTTP_HOST . RELATIVE_BASE_URL,
	...
	*******************/
	...
	'hidden_files'                            => array( 'config.php', 'index.html', 'index.htm', 'index.php' ),
